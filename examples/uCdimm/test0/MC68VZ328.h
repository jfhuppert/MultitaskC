...
#define TMR1_IRQ_NUM	1	/* Timer 1 interrupt */
...
typedef struct {
  volatile unsigned short int ustcnt __attribute__((packed));
  volatile unsigned short int ubaud  __attribute__((packed));
  union {
    volatile unsigned short int w    __attribute__((packed));
    struct {
      volatile unsigned char status  __attribute__((packed));
      volatile unsigned char rxdata  __attribute__((packed));
    } b;
  } urx;
  union {
    volatile unsigned short int w    __attribute__((packed));
    struct {
      volatile unsigned char status  __attribute__((packed));
      volatile unsigned char txdata  __attribute__((packed));
    } b;
  } utx;
  volatile unsigned short int umisc  __attribute__((packed));
  volatile unsigned short int nipr   __attribute__((packed));
} m68328_uart;
