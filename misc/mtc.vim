...
syn keyword	cStatement	goto break return continue asm execute and meeting block group join
syn keyword	cLabel		case default
syn keyword	cConditional	if else switch when
